...
class ProductQuickView {
  constructor() {
      ...
      (0,events/* addEventDelegate */.X)({
        ...
        handler: async (e, btn) => {
          try {
            ...
            let quickView = this.products?.[productHandle]?.quickView;
            ...
            if (!quickView) {
              ...
              const prodQuickviewURL = formatUrl('products', productHandle, 'view=quickview');
    ...
    (0,defineProperty/* default */.Z)(this, "renderPreOrderNote", () => {
      ...
      this.domNodes?.formActions?.appendChild(product_quick_view_createElement(PreOrderNote, {
        settings: settings
      }));
    });

    (0,defineProperty/* default */.Z)(this, "toggleLoading", _ref => {
      let {
        btn,
        loading
      } = _ref;
...
MinimogTheme.ProductQuickView = new ProductQuickView();
MinimogEvents.subscribe('ON_ITEM_ADDED', () => MinimogTheme.ProductQuickView.close());
}();
/******/ })()
;